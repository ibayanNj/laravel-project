    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-8">
        <a href="{{ route('admin.users') }}"
          class="text-indigo-600 hover:text-indigo-800 font-medium inline-flex items-center mb-4">
        ...
        <form action="{{ route('admin.users.update', $user) }}" method="POST">
          ...
          <div class="mb-6">
            ...
            <select name="role" id="role"
              ...
              required>
              <option value="user" {{ old('role', $user->role) === 'user' ? 'selected' : '' }}>Intern</option>
              <option value="supervisor" {{ old('role', $user->role) === 'supervisor' ? 'selected' : '' }}>Supervisor
              </option>
