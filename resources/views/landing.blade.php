...
<body>
  ...
  <section id="features" class="section-padding bg-light">
   ...
   <section class="section-padding bg-light">
    <div class="container">
      <div class="text-center mb-5">
        <h2 class="display-5 fw-bold">Submitted By</h2>
      </div>
          ...
          <div class="card shadow-sm border-0 p-4">
            <div class="card-body">
              <div class="text-center mb-4">
                <div class="mb-3">
                  <img src="{{ asset('images/Developer.jpeg') }}" alt="Developer" class="rounded-circle d-block mx-auto" style="width: 150px; height: 150px; object-fit: cover;">
                </div>
                <h4 class="fw-bold mb-2">Noel Jr. T. Ibayan</h4>
                <p>BSINFOTECH 4B Student</p>
              </div>
              
              <div class="mt-4">
                <h5 class="fw-bold mb-3 text-center">
                  <i class="bi bi-stack text-primary"></i> Tech Stack Used
                </h5>
                <div class="row g-3">
                  <div class="col-md-4">
                    <div class="text-center p-3 bg-white rounded shadow-sm">
                      <img src="{{ asset('images/Laravel.svg') }}" alt="Laravel" style="width: 60px; height: 60px; object-fit: contain;">
                      <h6 class="mt-2 mb-0 fw-bold">Laravel</h6>
                      <small class="text-muted">Backend Framework</small>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="text-center p-3 bg-white rounded shadow-sm">
                      <img src="{{ asset('images/mysql.svg') }}" alt="MySQL" style="width: 60px; height: 60px; object-fit: contain;">
                      <h6 class="mt-2 mb-0 fw-bold">MySQL</h6>
                      <small class="text-muted">Database</small>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="text-center p-3 bg-white rounded shadow-sm">
                      <img src="{{ asset('images/Tailwind.svg') }}" alt="Tailwind CSS" style="width: 60px; height: 60px; object-fit: contain;">
                      <h6 class="mt-2 mb-0 fw-bold">Tailwind CSS</h6>
