        ...
        <div class="p-6">
          <form action="{{ route('logs.update', $log->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input type="number" id="hours_worked" name="hours_worked"
                  value="{{ old('hours_worked', $log->hours_worked) }}" min="0.5" step="0.5" required
                  class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition">
              </div>
            </div>
            ...
            <div class="mt-6">
              ...
              <textarea id="tasks" name="tasks" rows="4" placeholder="What did you work on today?"
            ...
            <div class="mt-6">
              ...
              <input type="text" id="skills" name="skills" value="{{ old('skills', $log->skills) }}"
            ...
            <div class="mt-6">
              ...
              <input type="text" id="challenges" name="challenges" value="{{ old('challenges', $log->challenges) }}"
            ...
            <div class="mt-6">
              ...
              <input type="text" id="learnings" name="learnings" value="{{ old('learnings', $log->learnings) }}"
